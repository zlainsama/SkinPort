...
public class SkinPortGuiCustomizeSkin extends GuiScreen
{
    ...
    {
        return part.getDisplayName().getFormattedText() + ": " + (SkinCustomization.contains(SkinCustomization.ClientFlags, part) ? I18n.format("options.on", new Object[0]) : I18n.format("options.off", new Object[0]));
    }
